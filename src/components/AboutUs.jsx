function AboutUs() {
  return (
    <section id="about-us" className="bg-gradient-to-b from-[#DDFBFF] to-[#C5FA19]/30 py-16 px-10 relative overflow-hidden">
      
      {/* Floating Decorative Icons */}
      <img src="/icon-1.webp" alt="" className="absolute top-32 left-16 w-20 h-20 animate-bounce z-20" style={{animationDuration: '3s'}} />
      <img src="/icon-2.webp" alt="" className="absolute top-20 right-12 w-24 h-24 z-20" />
      <img src="/icon-3.webp" alt="" className="absolute top-[500px] left-8 w-20 h-20 animate-bounce z-20" style={{animationDuration: '4s'}} />
      <img src="/icon-4.webp" alt="" className="absolute top-[600px] right-16 w-32 h-32 z-20" />
      <img src="/icon-5.webp" alt="" className="absolute bottom-96 left-24 w-28 h-28 z-20" />
      <img src="/icon-6.webp" alt="" className="absolute bottom-64 right-20 w-22 h-22 animate-bounce z-20" style={{animationDuration: '5s'}} />
      <img src="/icon-7.webp" alt="" className="absolute bottom-32 left-40 w-24 h-24 z-20" />
      <img src="/icon-8.webp" alt="" className="absolute top-[800px] right-32 w-18 h-18 z-20" />
      <img src="/icon-9.webp" alt="" className="absolute bottom-48 right-48 w-20 h-20 z-20" />
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          {/* Story Card */}
          <div className="bg-white/80 backdrop-blur-sm rounded-[30px] p-8 shadow-xl border-4 border-[#461AA2]/20">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-4xl">🌊</span>
              <h3 className="text-2xl font-extrabold text-[#461AA2]">Our Story</h3>
            </div>
          ...
          {/* Facilities Card */}
          <div className="bg-[#461AA2] rounded-[30px] p-8 shadow-xl">
            <div className="flex items-center gap-3 mb-4">
              <span className="text-4xl">⭐</span>
        ...
        {/* Experience Section */}
        <div className="bg-gradient-to-r from-[#00D4D4] to-[#461AA2] rounded-[30px] p-8 shadow-2xl mb-8">
          <h3 className="text-3xl font-extrabold text-white mb-4 text-center">
            🎢 The Ultimate Water Adventure!
          </h3>
          <p className="text-white leading-relaxed text-center max-w-4xl mx-auto mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          {/* Parking Card */}
          <div className="bg-[#C5FA19] rounded-[25px] p-6 shadow-lg">
            <div className="text-4xl mb-3 text-center">🚗</div>
            <h4 className="text-xl font-bold text-[#461AA2] mb-2 text-center">Ample Parking</h4>
          ...
          {/* Food Card */}
          <div className="bg-[#FF6B35] rounded-[25px] p-6 shadow-lg">
            <div className="text-4xl mb-3 text-center">🍕</div>
            <h4 className="text-xl font-bold text-white mb-2 text-center">Delicious Food</h4>
          ...
          {/* Family Card */}
          <div className="bg-[#00D4D4] rounded-[25px] p-6 shadow-lg">
            <div className="text-4xl mb-3 text-center">🌳</div>
            <h4 className="text-xl font-bold text-[#461AA2] mb-2 text-center">Perfect Picnic Spots</h4>
            <p className="text-sm text-gray-800 leading-relaxed text-center">
        ...
        {/* Booking CTA */}
        <div className="bg-[#461AA2] rounded-[30px] p-10 shadow-2xl text-center relative overflow-hidden">
          ...
          <p className="text-xl text-[#C5FA19] font-bold mb-6 relative z-10">
            📞 For Booking: 08956118571 / 72
          </p>
          <p className="text-white text-lg mb-6 relative z-10 italic">
            "Life is more fun if you come to the water park"
          </p>
          <button className="bg-[#C5FA19] text-[#461AA2] px-10 py-4 rounded-full text-lg font-bold shadow-xl hover:scale-105 hover:bg-white transition-all duration-300 relative z-10">
            Book Your Visit Now
          </button>
        </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-2xl font-bold text-[#461AA2] leading-relaxed">
