  ...
  return (
    <section className="bg-gradient-to-b from-[#DDFBFF] via-[#C5FA19]/20 to-[#DDFBFF] py-10 md:py-16 px-4 md:px-10 relative overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        {/* Map / Directions CTA */}
        <div className="bg-gradient-to-r from-[#461AA2] to-[#00D4D4] rounded-[30px] p-6 md:p-12 shadow-2xl text-center relative overflow-hidden">
          
          <div className="absolute inset-0 bg-[radial-gradient(circle,_rgba(197,250,25,0.1),transparent_70%)]"></div>
          
          <div className="relative z-10">
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-white mb-4">
